# 🍽️ MANUAL DE USUARIO - CHECKIT DIGITAL MENU
...
Una **WebApp móvil** que reemplaza los menús físicos del resturante con una experiencia digital. Los clientes escanean un QR en su mesa y pueden:
...
- **Pantalla inicial** con 4 opciones grandes:
  - 🍽️ **Comidas** (menú principal)
  - 🥐 **Desayuno** (especialidades matutinas)
  - 📅 **Menú del día** (ofertas especiales)
  - 📋 **Menú [Nombre del Restaurante]** (menú completo)
...
**Checkit** hace que ordenar comida sea **más fácil, rápido y sin contacto físico**.
...
**¡Disfruta tu experiencia digital en [Nombre del restaurante aquí]!** 🍽️✨

...
// Helper methods
AppConstants.getFullVersion = () =>
  `${AppConstants.APP.NAME} v${AppConstants.APP.VERSION}`;
AppConstants.getBuildInfo = () =>
  `${AppConstants.APP.VERSION} (${AppConstants.APP.COMMIT_DATE})`;

/* ==========================================================================
   Log inicial
   ========================================================================== */
console.log(
  `${AppConstants.DEBUG.PREFIX} Constants loaded - ${AppConstants.getFullVersion()}`
);
